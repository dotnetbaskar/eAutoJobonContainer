...
namespace PlanGeneration.Domain.AggregatesModel.PlangenerationAggregate
{
        ...
        private int _orderStatusId;
            ...
            public Job(int jid) : this()
            {
                ...
                AddOrderStartedDomainEvent(_jobid);
            }
            ...
            private void AddOrderStartedDomainEvent(string jid)
            {
                var orderStartedDomainEvent = new PlangenerationstartedDomainEvent(jid,"started");
